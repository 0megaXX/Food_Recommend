        ...
        Column(
            ...
            Column(
                ...
                Row(
                    ...
                    OrangeButton(text = "다시 뽑기", onClick = {
                        val data = items.shuffled()
                        val json = Json.encodeToString(data)
                        navController.navigate("random_scroll/$json")
                    })

                    OrangeButton(text = "결정!", onClick = {
                        showDialog = true
                    })
                }
                    ...
                    Dialog(onDismissRequest = { showDialog = false }) {
                        Surface(
                            ...
                            Column(
                                ...
                                Text(text = "'$chooseItem' 음식점", style = TextStyle(
                                    fontFamily = PretendardFamily,
                                    fontWeight = FontWeight.SemiBold,
                                    fontSize = 20.sp,
                                    lineHeight = 20.sp,
                                ...
                                Text(text = "정보를 확인하겠습니까?", style = TextStyle(
                                    fontFamily = PretendardFamily,
                                    fontWeight = FontWeight.SemiBold,
                                    fontSize = 20.sp,
                                    lineHeight = 20.sp,
                                ...
                                Text(text = "근처 음식점 중 하나의 식당 정보를 확인 합니다.",
                                    style = TextStyle(
                                        fontFamily = PretendardFamily,
...
@Composable
@Preview
fun `$Preview_RouletteDrawResultScreen`() {
